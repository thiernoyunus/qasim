...
final class Preferences {
    ...
    /// Ask before the prayer and wait for an answer, instead of a bubble that
    /// fades on its own.
    var salahAsk = true
    /// After a borrowed minute runs out, he walks to the middle of the screen
    /// and calls you to prayer instead of waiting in the corner.
    ...
    private let key = "qasim.preferences.v1"
    ...
    var motionReduced: Bool { reducedMotion || systemReducedMotion }
